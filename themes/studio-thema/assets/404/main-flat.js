...
$(window).load(function() {
    ...
    MESSAGES.push({
        delay: 800,
        text: 'Возможно вы ошиблись набирая URL.'
    });
    MESSAGES.push({
        delay: 1800,
        text: 'Или страница была удалена.'
    });
    MESSAGES.push({
        delay: 3200,
        text: 'В любом случае делать тут нехер...'
    });
    MESSAGES.push({
        delay: 4800,
        text: 'Тыкай в ссылки ниже, или воспользуйся главным меню!'
    });
    $container = $('#container');
    $message = $('#message');
    $animate = $('#animate');
